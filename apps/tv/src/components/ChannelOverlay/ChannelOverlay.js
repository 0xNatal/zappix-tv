...
// Item height = logo (2.8rem ≈ 67px) + padding (2 × 0.75rem ≈ 36px) = ~103px
const ITEM_HEIGHT = ri.scale(102);
const ITEM_SPACING = ri.scale(3);

const ChannelOverlay = ({channels, currentChannelId, getEpg, onSelect, onVisibleRangeChange, visible}) => {
